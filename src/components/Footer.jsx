...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} mb-8 w-full md:flex-row flex-col`}>
    ...
    <div className="w-full md:flex-row flex-col flex pt-6 border-t-[1px] border-t-[#3f3e45] justify-between items-center">
